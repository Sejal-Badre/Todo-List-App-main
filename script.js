...
let sortOrder = 'none'; // 'asc', 'desc', or 'none'
let searchQuery = '';
...
const renderCategories = () => {
  ...
  categories.forEach((category) => {
    ...
    div.addEventListener("click", () => {
      ...
      // Reset search and sort when switching categories
      searchQuery = '';
      sortOrder = 'none';
      document.getElementById('search-input').value = '';
      document.getElementById('sort-button').textContent = 'Sort A-Z';
...
const renderTasks = () => {
  ...
  const categoryTasks = tasks.filter(
   ...
   // Apply sorting
   if (sortOrder === 'asc') {
    categoryTasks.sort((a, b) => a.task.localeCompare(b.task));
  } else if (sortOrder === 'desc') {
    categoryTasks.sort((a, b) => b.task.localeCompare(a.task));
  }
  // Update sort button text
  document.getElementById('sort-button').textContent = 
    sortOrder === 'asc' ? 'Sort Z-A' : 
    sortOrder === 'desc' ? 'Sort None' : 'Sort A-Z';
